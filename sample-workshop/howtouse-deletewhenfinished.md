...
The Prerequisite "lab" is the first lab in a common folder on the oracle/common repo. Because this lab already exists, we can use a RAW/absolute URL instead:
...
This [APEX Workshop](https://oracle-livelabs.github.io/apex/spreadsheet/workshops/freetier/index.html) is a good example of a workshop with a single set of labs: [https://github.com/oracle-livelabs/apex/tree/main/spreadsheet](https://github.com/oracle-livelabs/apex/tree/main/spreadsheet).
